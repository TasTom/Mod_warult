    ...
    public abstract class Verb_UseAbility : Verb
    {
        ...
        protected override bool TryCastShot()
        {
            ...
            if (abilityDef != null && AbilityUserComp != null)
            {
                ...
                {
                    Messages.Message("Expedition33_AbilityNotReady".Translate(), MessageTypeDefOf.RejectInput);
                    return false;
                }
                ...
                if (success)
                {
                    ...
                    Messages.Message("Expedition33_AbilityExecuted".Translate(abilityDef.label), MessageTypeDefOf.PositiveEvent);
                }
                return success;
            }
